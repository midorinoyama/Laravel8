    ...
    @endif
      ...
      <div class="field text-right">
        @if (!Auth::guest() && Auth::user()->id == $book->user_id)
          <a href="{{route('books.edit', $book)}}"><button class="btn btn-outline-primary">投稿内容を編集する</button></a>
        @endif
      ...
      <div class="field-link text-right mt-5">
        <a href="{{route('books.index')}}"><button class="btn btn-secondary">一覧に戻る</button></a>
      </div>
